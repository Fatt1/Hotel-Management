...
<div class="p-8 space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
            ...
            <p class="text-slate-500 font-medium">Hệ thống quản trị khách sạn Urban Luxe - Quản lý danh sách khách hàng chuyên nghiệp.</p>
        </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div class="p-5 border-b border-slate-100 flex flex-col sm:flex-row gap-4 justify-between items-center">
            <form action="{{ route('admin.customers.index') }}" method="GET"
                id="filter-form" class="flex items-center gap-3 w-full">
                                ...
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    @can('customers.delete')
                                        <button data-customer-id="{{ $customer->id }}"
                                            class="btn-delete-customer action-btn text-rose-500 hover:bg-rose-50" title="Xóa">
